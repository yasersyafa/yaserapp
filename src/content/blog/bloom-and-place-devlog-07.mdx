...
4. **Architecture position per class.** Labelled by hand as core, manager, or view based on responsibility.
5. **SDP violations.** Every edge that goes from a low-I role to a high-I role.
